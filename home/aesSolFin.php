...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../style/config/jquery.dataTables.min.css">
	<link rel="stylesheet" type="text/css" href="../style/styleAesUser.css">
...
<body>
	...
	<div class="wrapper">
        ...
        <div id="content">
           ...
           <?php include('userTableRequestFin.php'); ?>
            
        </div>
    </div>

	<?php include('libs.php');?>
	<script type="text/javascript" src="../js/config/jquery.dataTables.min.js"></script>
	<script type="text/javascript" src="../js/jsAesUserRequestFin.js"></script>
