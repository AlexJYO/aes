...
<head>
	...
	<!-- -----------------------------My style --------------------------------------->
	<link rel="stylesheet" type="text/css" href="style/styleAesLog.css">
...
<body>
	...
	<div class="container">
		<div id="ciberLog">
			...
			<form id="ciberLog-form">
				<div class="form-group">
					<input type="text" id="ciberUser" placeholder="GMIN" class="form-control" required>							
				</div>	
		...
		<a class="btn btn-primary" href="home/aesRegis.php" role="button">Registrese</a>
	</form>
	...
	<!-- jQuery Custom Scroller CDN -->
	 ...
	 <!-- -------------------------------------My config js --------------------------------------->
	<script type="text/javascript" src="js/jsAesLog.js"></script>
</body>
</html>